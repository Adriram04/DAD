  ...
  const handleSubmit = async e =>{
    ...
    try{
      const res = await fetch("https://api.ecobins.tech/auth/register",{
        ...
        body:JSON.stringify(form), mode:"cors",
      });
      if(!res.ok) throw new Error(await res.text());
      alert("✅ Usuario registrado. Inicia sesión."); navigate("/");
    }catch(err){
    ...
    <div className="register-screen-container">
      ...
      <div className="info-panel">
        <img src="/logo.png" alt="EcoTech"
             className="logo-main pulse-strong"/>
        <img src="/logo.png" alt="logo-eco"
             className="bg-logo pulse-soft"/>
          ...
          <motion.div className="register-card"
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="input-group">
                ...
                <input name="usuario" placeholder="Nombre de usuario"
