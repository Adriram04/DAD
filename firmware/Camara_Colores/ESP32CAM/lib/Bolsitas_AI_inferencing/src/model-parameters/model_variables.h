...
const char* ei_classifier_inferencing_categories[] = { "Azul", "Gris", "Rosa" };
...
const ei_impulse_t impulse_712384_0 = {
    .project_id = 712384,
    .project_owner = "Amadeusz_24",
    .project_name = "Bolsitas_AI",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 3,

    .nn_input_frame_size = 6912,
    ...
    .visual_ad_grid_size_x = int((48 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((48 / 8) / 2 - 1),
...
ei_impulse_handle_t impulse_handle_712384_0 = ei_impulse_handle_t( &impulse_712384_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_712384_0;
